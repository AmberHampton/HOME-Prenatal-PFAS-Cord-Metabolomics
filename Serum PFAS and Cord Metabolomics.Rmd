...
<div style="border: 1px solid #000; padding: 10px; background-color: #FDECEF;">
  ...
  <ul>
    <li><b>Serum PFAS and Cord Metabolomics.Rmd</b> Source R Markdown file with the original analysis code and narrative text</li>
    <li><b>Serum-PFAS-and-Cord-Metabolomics.html</b> Rendered HTML output of the R Markdown file</li>
    <li><b>Serum-PFAS-and-Cord-Metabolomics.pdf</b> Rendered PDF output of the R Markdown file</li>
    <li><b>Figures/</b> Reference figures (mix of code-generated outputs, post-processed/annotated exports, and externally created figures) </li>
  </ul>

  <p><span style="font-size: 15px; font-weight: 800;">How to Run the Analysis</span></p>
  <ol>
    <li>Open the <code>.Rmd</code> and set your local paths (or update <code>root.dir</code>) so the project can find the analysis-ready inputs.</li>
